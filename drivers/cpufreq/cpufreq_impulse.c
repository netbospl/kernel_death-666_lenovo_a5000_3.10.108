...
#define DEFAULT_HISPEED_FREQ 998400
 ...
 * frequency.
 */
#define DEFAULT_MAX_HYSTERESIS 100000
static unsigned int max_freq_hysteresis = DEFAULT_MAX_HYSTERESIS;
